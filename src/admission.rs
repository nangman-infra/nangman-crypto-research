...
use crate::model::{CANDIDATE_BUNDLE_SCHEMA_VERSION, ConfidenceBand, IntelCandidateEvidenceBundle};
...
fn has_allowed_symbol_mapping(bundle: &IntelCandidateEvidenceBundle) -> bool {
