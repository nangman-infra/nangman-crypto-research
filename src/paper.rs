...
use crate::model::{
    ...
    PAPER_TRADE_SUMMARY_SCHEMA_VERSION, PAPER_WATCH_CANDIDATE_SCHEMA_VERSION, PaperAccountProfile,
    PaperExpectedCostProfile, PaperExpectedRiskProfile, PaperShadowSummary, PaperTradeCandidate,
    PaperTradeMark, PaperTradeRun, PaperTradeSummary, PaperWatchCandidate,
    PaperWatchReplaySampleSummary, PaperWatchSafety, ResearchBias, ResearchPartitionAggregate,
    ResearchRunReport, ShadowValidationRun, ShadowValidationStatus, SurvivalBand,
};
...
fn aggregates_by_candidate_key(
    aggregates: &[ResearchPartitionAggregate],
