...
impl Default for Args {
    fn default() -> Self {
        Self {
            ...
            focused_retest_next_actions: default_focused_retest_actions(),
            focused_retest_historical_replay_index_ref_mode: HistoricalReplayIndexRefMode::Auto,
            ...
            market_live_nats_stream: DEFAULT_MARKET_LIVE_NATS_STREAM.to_owned(),
            market_live_nats_subject: DEFAULT_MARKET_LIVE_NATS_SUBJECT.to_owned(),
            market_live_nats_consumer: DEFAULT_MARKET_LIVE_NATS_CONSUMER.to_owned(),
            market_live_nats_deliver_policy: DEFAULT_MARKET_LIVE_NATS_DELIVER_POLICY.to_owned(),
            market_live_nats_batch_size: DEFAULT_MARKET_LIVE_NATS_BATCH_SIZE,
            market_live_nats_max_messages: DEFAULT_MARKET_LIVE_NATS_MAX_MESSAGES,
            market_live_nats_ack_wait_secs: DEFAULT_MARKET_LIVE_NATS_ACK_WAIT_SECS,
